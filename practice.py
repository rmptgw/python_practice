...
# 패키지
# import 는 클래스명으로 해당 클래스를 가져올 수 없음. 모듈이나 패키지만 가능
# from ~ import 구분에서는 모듈이나 패키지, 클래스, 함수를 가져올 수 있음
...
# 외장함수
# glob: 경로 내 폴더/파일 목록 조회(윈도우 dir / 리눅스 ls)
# import glob
# print(glob.glob("*.py")) # 파일형식이 py인 모든 파일
