...
def retrycancel():
    responce = msgbox.askretrycancel("재시도/취소", "일시적인 오류입니다. 다시시도하시겠습니까?")
    print("응답: ", responce) # True, False, None -> 예 1, 아니오 0, 그 외
    if responce == 1: # 네, ok
        print("재시도")
    elif responce == 0: # 아니오
        print("취소")
...
def yesnocancel():
    responce = msgbox.askyesnocancel(title=None, message="예매내역이 저장되지 않았습니다.\n 저장 후 앱을 종료하시겟습니까?")
    # 네 : 저장 후 종료
    # 아니오 : 저장하지 않고 종료
